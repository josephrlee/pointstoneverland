...
return '... <p><a class="excerpt-read-more button" href="'. get_permalink($post->ID) . '" title="'. __('Read', 'jointswp') . get_the_title($post->ID).'">'. __('Continue Reading &raquo;', 'jointswp') .'</a></p>';
}
